...
public class AuditReportGeneratorService {
    ...
    private static final String REPORT_PATH = "D:\\IntelliJ projects\\Library-management\\src\\reports\\";
    ...
    public void addActionToReport(int option, String reportPath){
        ...
        String content = switch (option) {
            case 1 -> "An account has been verified.";
            ...
            case 12 -> "All the book have been shown";
            ...
            case 17 -> "A librarian has been deleted.";
            default -> "";
        };
